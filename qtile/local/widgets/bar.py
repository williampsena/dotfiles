...
from local.widgets.app_menu import build_app_menu_widget
from local.widgets.arrow import build_arrow_widget
from local.widgets.battery import build_battery_widget
from local.widgets.clock import build_clock_widget
from local.widgets.cpu import build_cpu_widget
from local.widgets.github import build_github_widget
from local.widgets.group_box import build_group_box
from local.widgets.helpers.args import build_widget_args
from local.widgets.hidden_tray import build_hidden_tray
from local.widgets.layout import build_current_layout_widget
from local.widgets.memory import build_memory_widget
from local.widgets.notification import build_notification_widget
from local.widgets.powermenu import build_powermenu_widget
from local.widgets.spacer import build_spacer_widget
from local.widgets.task_list import build_task_list_widget
from local.widgets.thermal import build_thermal_widget
from local.widgets.volume import build_volume_widget
from local.widgets.wallpaper import build_wallpaper_widget
from local.widgets.weather import build_weather_widget
from local.widgets.window_name import build_window_name_widget
